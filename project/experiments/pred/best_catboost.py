...
pred_path = r'C:\Users\Home\Downloads\bike-sharing-demand\csvs\preds\catboost_with_cats.csv'
...
print("\nОбучение с категориальными фичами...")
model.fit(X_tr, y_tr)
...
print(f"Файл сохранен: {pred_path}")